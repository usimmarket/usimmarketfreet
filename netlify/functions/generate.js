...
exports.handler = async (event) => {
  try{
    ...
    // NOTE: Checkmark glyph (✓) often fails with embedded fonts and can render as "&&".
    // For maximum compatibility, use a plain 'V'.
    const checkMark = "V";

    // Use a guaranteed built-in font for checkbox marks.
    const checkboxFont = await pdfDoc.embedFont(StandardFonts.HelveticaBold);
